...
public class WebPageTracker implements BundleActivator {
  ...
  private static final class MyBundleTracker extends BundleTracker<Object> {
    ...
    public MyBundleTracker(BundleContext context, int stateMask, BundleTrackerCustomizer<Object> customizer) {
