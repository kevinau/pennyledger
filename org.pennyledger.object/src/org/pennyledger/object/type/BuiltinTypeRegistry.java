...
import org.pennyledger.object.type.builtin.BigDecimalType;
import org.pennyledger.object.type.builtin.BigIntegerType;
import org.pennyledger.object.type.builtin.BooleanType;
import org.pennyledger.object.type.builtin.ByteType;
import org.pennyledger.object.type.builtin.CharacterType;
import org.pennyledger.object.type.builtin.DateType;
import org.pennyledger.object.type.builtin.DecimalType;
import org.pennyledger.object.type.builtin.DoubleType;
import org.pennyledger.object.type.builtin.EntityLifeType;
import org.pennyledger.object.type.builtin.EnumType;
import org.pennyledger.object.type.builtin.FileContentType;
import org.pennyledger.object.type.builtin.FloatType;
import org.pennyledger.object.type.builtin.IntegerType;
import org.pennyledger.object.type.builtin.LocalDateType;
import org.pennyledger.object.type.builtin.LongType;
import org.pennyledger.object.type.builtin.PathType;
import org.pennyledger.object.type.builtin.ShortType;
import org.pennyledger.object.type.builtin.SqlDateType;
import org.pennyledger.object.type.builtin.StringType;
import org.pennyledger.object.type.builtin.TimestampType;
import org.pennyledger.object.type.builtin.Type;
import org.pennyledger.object.type.builtin.URLType;
import org.pennyledger.object.value.EntityLife;
import org.pennyledger.object.value.FileContent;
import org.pennyledger.object.value.TimestampValue;

public class BuiltinTypeRegistry {
  ...
  static {
    ...
    typeMap.put(TimestampValue.class, TimestampType.class);
    typeMap.put(URL.class, URLType.class);
  }

  public static IType<?> lookupType(Class<?> fieldClass) {
    return lookupType(fieldClass, null, null);
  }
