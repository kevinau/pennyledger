...
public class RuntimeOccursProvider implements IRuntimeOccursProvider {
  ...
  public int getOccurs(Object instance) {
    if (field != null) {
      try {
        ...
        System.out.println("xxxx get occurs from field: " + n);
        return n;
      ...
      try {
        ...
        System.out.println("xxxx get occurs from method: " + n);
        return n;
      } catch (SecurityException ex) {
        throw new RuntimeException(ex);
      } catch (IllegalArgumentException ex) {
      ...
      System.out.println("xxxx get fixed size: " + size);
      return size;
    }
  }
