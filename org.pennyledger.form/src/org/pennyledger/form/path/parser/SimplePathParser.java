/* Generated By:JavaCC: Do not edit this line. SimplePathParser.java */
...
//  }
  ...
  final public Path topPath() throws ParseException {
    ...
    while (true) {
      ...
      ex = relativePath(new DescendentPath(ex));
    }
    if (jj_2_3(3)) {
      jj_consume_token(SLASHSLASH);
  ...
  public SimplePathParserTokenManager token_source;
  ...
  public SimplePathParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public SimplePathParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new SimplePathParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public SimplePathParser(java.io.Reader stream) {
  ...
  public SimplePathParser(SimplePathParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(SimplePathParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
