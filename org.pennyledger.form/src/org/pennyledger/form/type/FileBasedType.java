...
public abstract class FileBasedType<T extends File> extends Type<T> implements IType<T>, ITextBasedInput {
...
//  }
  ...
  @Override
  public abstract T createFromString (String source, T fillValue) throws UserEntryException;
